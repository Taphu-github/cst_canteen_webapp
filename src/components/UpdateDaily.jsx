...
class UpdateDaily extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount(){
        Product.getDailyMenuProductById(this.state.id).then((res)=>{
            ...
            this.setState({names: student.name,
                price: student.price, available:student.availability,
                canteenName: student.canteenname, url: student.url
            })
        });
    }
                ...
                <div className='container'>
                    <div className='row'>
                        <div className = 'card col-md-6 offset-md-3 offset-md-3'>
                            <h3 className='text-center'>Update Daily Menu</h3>
