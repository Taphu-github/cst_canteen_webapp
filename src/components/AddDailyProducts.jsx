...
class AddDailyProducts extends Component {
    constructor(props) {
        super(props);
    ...
    saveProduct=(e)=>{
        ...
        Product.addDailyMenuProduct(student).then(res =>{
                ...
                <div className='container'>
                    <div className='row'>
                        <div className = 'card col-md-6 offset-md-3 offset-md-3'>
                            <h3 className='text-center'>Add to Daily Menu</h3>
...
export default AddDailyProducts;