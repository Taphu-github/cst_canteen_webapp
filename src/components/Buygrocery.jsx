...
class Buygrocery extends Component {
    constructor(props) {
        super(props);
    ...
    orderProduct(e){
        ...
        let student={name: this.state.names, canteenname: this.state.canteenName, credit: this.state.credit, emailid:this.state.emailid, 
            products: this.state.products, totalamount:this.state.totalamount, state: 'Not Accepted', date: dates };
    ...
    creditProduct(e){
        ...
        let times= new Date();
        let dates='Year: '+times.getFullYear()+' Month: '+times.getMonth()+' Date: '+times.getDate()+' Hours(24hrs fromat): '+times.getHours()+' Minutes: '+times.getMinutes();
        let student={name: this.state.names, canteenname: this.state.canteenName, credit: 'true', emailid:this.state.emailid, 
        ...
        let productsolo={name: this.state.names, canteenname: this.state.canteenName, emailid:this.state.emailid, 
            products: this.state.products,quantity:this.state.quantity, totalamount:this.state.totalamount, state: 'Not Accepted', date: dates };
